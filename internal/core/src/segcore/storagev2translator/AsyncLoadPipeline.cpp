...
StorageV3HighPriorityExecutor() {
    return milvus::segcore::async_load::AsyncLoadMaterializeExecutor();
}
...
SubmitStorageV3ArrowExecutorTask(arrow::internal::Executor* executor,
                                 Func&& func) {
    return milvus::segcore::async_load::SubmitAsyncLoadExecutorTask<Result>(
...
StorageV3DiskExecutor() {
    return milvus::segcore::async_load::AsyncLoadDiskExecutor();
}
...
StorageV3AdmissionConfigFromLoadBudget() {
    return milvus::segcore::async_load::LoadAdmissionConfigFromLoadBudget();
}

StorageV3AdmissionScheduler&
GetStorageV3LoadAdmissionScheduler() {
    return milvus::segcore::async_load::GetLoadAdmissionScheduler();
}
