...
// offset is within the decoded destination; multi-file streaming concatenates
// the supplied payloads. Empty files produce one call.
...
// Consumers may overlap and must place disjoint ranges by offset.
// All issued work drains before return/throw.
