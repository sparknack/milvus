...
// The LOADER of the ngram family. The historical wire carries neither
...
class NgramIndexLoader final {
 public:
    static constexpr std::string_view kFamily = families::kNgram;
