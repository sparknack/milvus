...
DEFINE_PROMETHEUS_GAUGE_FAMILY(
    internal_arrow_io_pool_queue_depth_approx,
    "[cpp]arrow io thread pool approximate queue depth");
DEFINE_PROMETHEUS_GAUGE(internal_arrow_io_pool_queue_depth_approx_all,
                        internal_arrow_io_pool_queue_depth_approx,
                        {});
